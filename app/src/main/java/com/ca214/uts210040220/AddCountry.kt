...
class AddCountry : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val population : EditText = findViewById(R.id.populationEdit)
        val urlBendera : EditText = findViewById(R.id.urlEdit)
        val area : EditText = findViewById(R.id.areaEdit)
        val populationDensity : EditText = findViewById(R.id.populationDensityEdit)
        val coastline : EditText = findViewById(R.id.coastLineEdit)
        val netMigration : EditText = findViewById(R.id.netMigration)
        val infantMigration : EditText = findViewById(R.id.infantMortality)
        val gdp : EditText = findViewById(R.id.gdpEdit)
        val literacy : EditText = findViewById(R.id.literacyEdit)
        findViewById<Button>(R.id.submitButtonEdit).setOnClickListener {
            val countryNew : CountyModel = CountyModel(R.drawable.avatar_1, countryName.text.toString(), countryDesc.text.toString(), countryRegion.text.toString(), population.text.in)
